...
COMMENT ON COLUMN request.job_id IS 'Requested Oozie job Id (human readable)';
COMMENT ON COLUMN request.request_parameters IS 'Oozie job provided parameters';
COMMENT ON COLUMN request.job_launcher_id IS 'Oozie job Id (generated by Oozie Client API';
